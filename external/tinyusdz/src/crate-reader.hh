...
class CrateReader {
 ...
 public:
  ...
  struct FlatArrayData {
    const uint8_t *data = nullptr;
    uint64_t count = 0;
  };

  bool GetUncompressedArrayData(const crate::ValueRep &rep, FlatArrayData *out) const;
  bool UnpackValueRepForFlat(const crate::ValueRep &rep, crate::CrateValue *value);
