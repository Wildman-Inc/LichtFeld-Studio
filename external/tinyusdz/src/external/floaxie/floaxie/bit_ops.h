...
namespace floaxie {
     ...
     */
    template <typename NumericType>
    constexpr typename std::make_unsigned<NumericType>::type positive_part(NumericType value) noexcept {
     ...
     */
    template <typename NumericType>
    inline round_result round_up(NumericType last_bits, std::size_t round_to_power) noexcept {
        round_result ret;
