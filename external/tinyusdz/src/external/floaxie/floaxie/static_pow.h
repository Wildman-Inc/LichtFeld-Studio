...
namespace floaxie {
    ...
    struct static_pow_helper<base, 0> {
     ...
     */
    template <typename T, T Add, typename Seq>
     ...
     */
    template <typename T, T base, std::size_t current_pow>
    struct pow_sequencer {
