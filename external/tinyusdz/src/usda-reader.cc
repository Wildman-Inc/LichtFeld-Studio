...
#define RECONSTRUCT_PRIM_DECL(__ty) template <> \
bool ReconstructPrim<__ty>(const Specifier& spec, const PropertyMap&, const ReferenceList&, __ty*, std::string*, std::string*, const PrimReconstructOptions&)
