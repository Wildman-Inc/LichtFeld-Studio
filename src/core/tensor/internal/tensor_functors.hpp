...
#define LFS_TENSOR_DEVICE_COMPILER 1
#define HOST_DEVICE __host__ __device__
#include <thrust/tuple.h>
#else
#define LFS_TENSOR_DEVICE_COMPILER 0
#define HOST_DEVICE
#include <tuple>
#endif
...
#if defined(__CUDA_ARCH__) || defined(__HIP_DEVICE_COMPILE__) || defined(__HIPCC__)
...
#if defined(__CUDA_ARCH__) || defined(__HIP_DEVICE_COMPILE__) || defined(__HIPCC__)
                    return static_cast<T>(fmodf(static_cast<float>(a), static_cast<float>(b)));
#else
                    return std::fmod(a, b);
#endif
                }
