...
namespace lfs::core {
    ...
    template <typename T>
    [[nodiscard]] constexpr uint64_t cuda_breadcrumb_arg(T value) noexcept {
...
#define LFS_CUDA_DETAIL_CHECK_IMPL(call, stream_value, arg0, arg1, arg2, message)     \
    do {                                                                              \
        ...
        const uint64_t _lfs_cuda_arg0 = ::lfs::core::cuda_breadcrumb_arg(arg0);       \
        const uint64_t _lfs_cuda_arg1 = ::lfs::core::cuda_breadcrumb_arg(arg1);       \
        const uint64_t _lfs_cuda_arg2 = ::lfs::core::cuda_breadcrumb_arg(arg2);       \
...
#define LFS_CUDA_BREADCRUMB_ARGS(tag, arg0, arg1, arg2)                                \
    do {                                                                               \
        ...
        ::lfs::core::record_cuda_breadcrumb(                                           \
            ...
            ::lfs::core::cuda_breadcrumb_arg(arg0),                                    \
            ::lfs::core::cuda_breadcrumb_arg(arg1),                                    \
            ::lfs::core::cuda_breadcrumb_arg(arg2));                                   \
    } while (false)
